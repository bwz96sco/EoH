...
# ARIS Alias: aris-deepxiv

This project-local skill is an alias for upstream ARIS skill `deepxiv`.

Before doing any task for this skill:

1. Read `/Users/zhangbowen/Projects/NewTools-Research/Auto-claude-code-research-in-sleep/skills/deepxiv/SKILL.md`.
