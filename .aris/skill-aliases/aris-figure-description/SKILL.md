...
# ARIS Alias: aris-figure-description

This project-local skill is an alias for upstream ARIS skill `figure-description`.

Before doing any task for this skill:

1. Read `/Users/zhangbowen/Projects/NewTools-Research/Auto-claude-code-research-in-sleep/skills/figure-description/SKILL.md`.
