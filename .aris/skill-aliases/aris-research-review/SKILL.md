...
# ARIS Alias: aris-research-review

This project-local skill is an alias for upstream ARIS skill `research-review`.

Before doing any task for this skill:

1. Read `/Users/zhangbowen/Projects/NewTools-Research/Auto-claude-code-research-in-sleep/skills/research-review/SKILL.md`.
