...
# ARIS Alias: aris-idea-creator

This project-local skill is an alias for upstream ARIS skill `idea-creator`.

Before doing any task for this skill:

1. Read `/Users/zhangbowen/Projects/NewTools-Research/Auto-claude-code-research-in-sleep/skills/idea-creator/SKILL.md`.
