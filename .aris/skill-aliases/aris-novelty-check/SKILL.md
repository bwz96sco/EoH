...
# ARIS Alias: aris-novelty-check

This project-local skill is an alias for upstream ARIS skill `novelty-check`.

Before doing any task for this skill:

1. Read `/Users/zhangbowen/Projects/NewTools-Research/Auto-claude-code-research-in-sleep/skills/novelty-check/SKILL.md`.
