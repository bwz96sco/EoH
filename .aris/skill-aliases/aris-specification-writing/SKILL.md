...
# ARIS Alias: aris-specification-writing

This project-local skill is an alias for upstream ARIS skill `specification-writing`.

Before doing any task for this skill:

1. Read `/Users/zhangbowen/Projects/NewTools-Research/Auto-claude-code-research-in-sleep/skills/specification-writing/SKILL.md`.
