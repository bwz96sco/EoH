...
# ARIS Alias: aris-run-experiment

This project-local skill is an alias for upstream ARIS skill `run-experiment`.

Before doing any task for this skill:

1. Read `/Users/zhangbowen/Projects/NewTools-Research/Auto-claude-code-research-in-sleep/skills/run-experiment/SKILL.md`.
