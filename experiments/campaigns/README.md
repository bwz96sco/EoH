...
| 3G Hardset Round 2 | large-pop + single-seed + dataset-balanced objective 验证 3G plateau 是否可突破 | running | Stage 1 screening running | [tracker](3g-hardset-round2.md) |
